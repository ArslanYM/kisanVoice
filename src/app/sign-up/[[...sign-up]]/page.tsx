  ...
  return (
    <main className="font-sans min-h-screen bg-[#050806] flex flex-col items-center justify-center px-5 py-12 relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute bottom-0 right-0 h-72 w-72 rounded-full bg-lime-400/8 blur-[80px]" />
      </div>
      ...
      <div className="mb-8 text-center max-w-md">
        ...
        <p className="text-[17px] text-zinc-400 font-medium leading-relaxed">
          Create your account — then continue to language setup and the full
          voice + intel experience.
        </p>
      </div>
      <SignUp
